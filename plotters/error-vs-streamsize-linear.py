...
for gname in graph_names:
    for reservoir in exp_range(75000, 600 * 1000 + 1, 2):
        for gamma in [0.5, 0.6, 0.7, 0.8, 0.9]:
            ...
            if gname != 'movie-lens' or gamma != 0.9 or reservoir != 300 * 1000:
                continue
            ...
            oldAda_error = scipy.signal.savgol_filter(oldAda_error, 9, 3)
            Ada_error = scipy.signal.savgol_filter(Ada_error, 9, 3)
            ...
            algorithms = ['Res', 'IRes', 'Ada', 'oldAda', 'IAda']
            ...
            ax.plot(new_batches, oldAda_error, alpha=alpha, color=colors[0], linewidth=lw, linestyle=linestyles[0], markeredgecolor='k', solid_capstyle='round', dash_capstyle='round')
            ax.plot(new_batches, Ada_error, alpha=alpha, color=colors[1], linewidth=lw, linestyle=linestyles[1], markeredgecolor='k', solid_capstyle='round', dash_capstyle='round')
            ax.plot(new_batches, IAda_error, alpha=alpha, color=colors[2], linewidth=lw, linestyle=linestyles[2], markeredgecolor='k', solid_capstyle='round', dash_capstyle='round')
