...
algorithms = ['Ada', 'Ada-cumsum', 'Ada-cumsum++']
...
for gname in graph_names:
    for reservoir in exp_range(75000, 600 * 1000 + 1, 2):
        for gamma in [0.5, 0.6, 0.7, 0.8, 0.9]:
            ...
            ax.figure.savefig(output_path + '/runtime-stream-' + gname + '-gamma=' + str(gamma) + '-res-sz=' + str(reservoir) + '.pdf', format='pdf', bbox_inches='tight', dpi=300)
